...
import (
	...
	"golang.org/x/mod/v2/modfile"
	"golang.org/x/mod/v2/module"
	"golang.org/x/mod/v2/semver"
	modzip "golang.org/x/mod/v2/zip"
)
...
func (r *codeRepo) Zip(ctx context.Context, dst io.Writer, version string) error {
	...
	return modzip.Create(dst, module.Version{Path: r.modPath, ModFilename: r.modFilename, Version: version}, files)
}
